      ...
      <div className={styles.title}>
        <span className={styles.projectIcon}>
          ...
          >
            ...
            />
            <path
              d="M0.758057 12.75L11.2851 17.828C11.5039 17.941 11.7467 18 11.9931 18C12.2394 18 12.4822 17.941 12.7011 17.828L23.2581 12.75"
              stroke="#6D83D2"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M0.758057 17.25L11.2851 22.328C11.5039 22.441 11.7467 22.5 11.9931 22.5C12.2394 22.5 12.4822 22.441 12.7011 22.328L23.2581 17.25"
              stroke="#6D83D2"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
